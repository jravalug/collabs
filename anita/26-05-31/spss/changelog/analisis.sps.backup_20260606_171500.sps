...
********************************************************************************
* BLOQUE 12. EXPORTACIÓN PDF
*   Genera un PDF con todos los resultados del análisis.
*   Si la ruta cambia, actualizarla manualmente.
********************************************************************************.

OUTPUT EXPORT
  /CONTENTS EXPORT=VISIBLE
  /PDF
    OUTPUTFILENAME='C:\Users\jravalug\OneDrive\Documents\Collaborations\anita\2026-05-31\ok\resultados_analisis.pdf'.
...
try:
    ...
    if dataDoc is None:
        ...
        varCount = dataDoc.GetVariableCount()
        existing_vars = []
        for i in range(varCount):
            existing_vars.append(dataDoc.GetVariableAt(i).GetName())
